...
import Section4.EntitiesWorker.Department;
import Section4.EntitiesWorker.Enums.WorkerLevel;
import Section4.EntitiesWorker.HourContract;
import Section4.EntitiesWorker.Worker;
...
public class WorkerProgram {
    public static void main(String[] args) throws ParseException {
        ...
        Worker worker = new Worker(workerName, WorkerLevel.valueOf(workerLevel), workerBaseSalary, new Department(departamentName));
